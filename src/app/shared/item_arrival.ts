...
export const TIMELINES: ItemArrival[] = [
    ...
    {item_id : {"node_number" : "Node 2", "item_number" : 15}, arrival_time : 15},
    {item_id : {"node_number" : "Node 2", "item_number" : 25}, arrival_time : 15},
    {item_id : {"node_number" : "Node 2", "item_number" : 35}, arrival_time : 10},
    {item_id : {"node_number" : "Node 2", "item_number" : 12}, arrival_time : -10},
    {item_id : {"node_number" : "Node 2", "item_number" : 23}, arrival_time : -7},
    {item_id : {"node_number" : "Node 2", "item_number" : 30}, arrival_time : -9},
